 ...
 */
class getConsole_Command_CacheWarmupService extends App_KernelLocalDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/symfony/framework-bundle/Command/CacheWarmupCommand.php';
