 ...
 */
class getConsole_ErrorListenerService extends App_KernelLocalDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/symfony/console/EventListener/ErrorListener.php';
