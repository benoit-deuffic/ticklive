 ...
 */
class getRedirectControllerService extends App_KernelLocalDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/symfony/framework-bundle/Controller/RedirectController.php';
