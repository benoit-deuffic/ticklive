 ...
 */
class getDoctrine_Migrations_ContainerAwareMigrationsFactoryService extends App_KernelLocalDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/doctrine/migrations/lib/Doctrine/Migrations/Version/MigrationFactory.php';
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/doctrine/doctrine-migrations-bundle/MigrationsFactory/ContainerAwareMigrationFactory.php';
