 ...
 */
class getConsole_CommandLoaderService extends App_KernelLocalDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/symfony/console/CommandLoader/CommandLoaderInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/symfony/console/CommandLoader/ContainerCommandLoader.php';
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Application\\Product\\Create\\DBALCreateProductCommand' => ['privates', '.App\\Application\\Product\\Create\\DBALCreateProductCommand.lazy', 'getDBALCreateProductCommand_LazyService', true],
            'App\\Application\\Product\\Create\\MockCreateProductCommand' => ['privates', '.App\\Application\\Product\\Create\\MockCreateProductCommand.lazy', 'getMockCreateProductCommand_LazyService', true],
            'App\\Application\\Product\\List\\DBALListProductCommand' => ['privates', '.App\\Application\\Product\\List\\DBALListProductCommand.lazy', 'getDBALListProductCommand_LazyService', true],
            'App\\Application\\Product\\List\\MockListProductCommand' => ['privates', '.App\\Application\\Product\\List\\MockListProductCommand.lazy', 'getMockListProductCommand_LazyService', true],
            'App\\Application\\Product\\Search\\DBALSearchProductCommand' => ['privates', '.App\\Application\\Product\\Search\\DBALSearchProductCommand.lazy', 'getDBALSearchProductCommand_LazyService', true],
            'App\\Application\\Product\\Search\\MockSearchProductCommand' => ['privates', '.App\\Application\\Product\\Search\\MockSearchProductCommand.lazy', 'getMockSearchProductCommand_LazyService', true],
            ...
            'App\\Application\\Product\\Create\\DBALCreateProductCommand' => '?',
            'App\\Application\\Product\\Create\\MockCreateProductCommand' => '?',
            'App\\Application\\Product\\List\\DBALListProductCommand' => '?',
            'App\\Application\\Product\\List\\MockListProductCommand' => '?',
            'App\\Application\\Product\\Search\\DBALSearchProductCommand' => '?',
            'App\\Application\\Product\\Search\\MockSearchProductCommand' => '?',
