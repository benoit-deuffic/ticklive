 ...
 */
class getCacheWarmerService extends App_KernelLocalDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/symfony/http-kernel/CacheWarmer/CacheWarmerInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Symfony/vendor/symfony/http-kernel/CacheWarmer/CacheWarmerAggregate.php';
        ...
        }, 3), true, ($container->targetDir.''.'/App_KernelLocalDebugContainerDeprecations.log'));
    }
}
