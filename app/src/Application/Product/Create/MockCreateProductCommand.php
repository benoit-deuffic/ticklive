...
use App\Infrastructure\Adapter\Mock\ProductPersister;
...
#[AsCommand(
    name: 'app:mock-create-product',
    description: 'Mock: Creates a new Product.',
    hidden: false,
    aliases: ['app:mock-add-product']
)]

class MockCreateProductCommand extends Command
{
    private $persister;
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $product->setIsFood(array_rand($is_food_values));
